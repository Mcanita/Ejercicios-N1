using System;
// Una importante marca de computadoras permite elegir cierta configuración del equipo a 
// comprar. Para ello existe la siguiente escala de precios:
...
namespace e3
{
    class Program
    {
        static void Main(string[]args)
        {
            ...
            Console.WriteLine("EL PRECIO TOTAL A ABONAR ES : "+precio);
        }
    }
}
